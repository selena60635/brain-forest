...
function BtnsGroup({ addNode, selectedNodes, rootNode, delNode }) {
  const handleAddNode = (e) => {
    e.stopPropagation(); // 阻止事件冒泡
    if (selectedNodes[0]) {
      addNode(selectedNodes[0] === rootNode.id ? null : selectedNodes[0]);
    } else {
    ...
    <>
      ...
      >
        <svg
          ...
          id="svg1"
        >
          <g transform="matrix(1.494007,0,0,1.362462,-12.128475,-4.5621977)">
            <rect
              style={{
                fill: "none",
                fillOpacity: 1,
